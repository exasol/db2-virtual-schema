# Virtual Schema for DB2 4.0.0, released 2026-05-26
...
* #41: Added anonymous feature-usage tracking
...
* Updated `com.exasol:exasol-testcontainers:7.1.5` to `7.3.0`
...
* Updated `com.exasol:virtual-schema-common-jdbc:13.0.0` to `14.0.2`
* Updated `com.ibm.db2:jcc:12.1.0.0` to `12.1.4.0`
...
* Removed `org.testcontainers:db2:1.21.1`
* Removed `org.testcontainers:junit-jupiter:1.21.1`
* Added `org.testcontainers:testcontainers-db2:2.0.5`

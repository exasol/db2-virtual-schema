...
public class IntegrationTestConfiguration {
    ...
    public static final String DB2_DOCKER_REFERENCE = "ibmcom/db2:11.5.6.0a";
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-9.0.3-db2-2.0.2.jar";

...
public class IntegrationTestConfiguration {
    public static final String EXASOL_DOCKER_REFERENCE = "7.1.11";
    public static final String DB2_DOCKER_REFERENCE = "ibmcom/db2:11.5.7.0a";
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-9.0.5-db2-2.0.4.jar";

...
public class IntegrationTestConfiguration {
    public static final String EXASOL_VERSION = "2026.1.0";
    // Available versions: https://icr.io/v2/db2_community/db2/tags/list
    public static final String DB2_DOCKER_REFERENCE = "icr.io/db2_community/db2:12.1.4.0";
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-14.0.2-db2-4.0.0.jar";

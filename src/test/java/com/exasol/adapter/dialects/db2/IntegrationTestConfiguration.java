...
public class IntegrationTestConfiguration {
    ...
    public static final String DB2_DOCKER_REFERENCE = "icr.io/db2_community/db2:11.5.8.0";
    public static final String VIRTUAL_SCHEMAS_JAR_NAME_AND_VERSION = "virtual-schema-dist-10.5.0-db2-2.1.1.jar";

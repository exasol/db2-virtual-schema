...
| [IBM Data Server Driver for JDBC and SQLJ][20]  | [International Program License Agreement (IPLA)][21] |
...
| Dependency                    | License                                                                                                        |
| ----------------------------- | -------------------------------------------------------------------------------------------------------------- |
| [JSON-P Default Provider][26] | [Eclipse Public License 2.0][27]; [GNU General Public License, version 2 with the GNU Classpath Exception][28] |
...
| [Maven Flatten Plugin][35]                              | [Apache Software License][32]                  |
| [org.sonatype.ossindex.maven:ossindex-maven-plugin][36] | [ASL2][37]                                     |
| [Maven Surefire Plugin][38]                             | [Apache-2.0][32]                               |
| [Versions Maven Plugin][39]                             | [Apache License, Version 2.0][32]              |
| [duplicate-finder-maven-plugin Maven Mojo][40]          | [Apache License 2.0][41]                       |
| [Apache Maven Artifact Plugin][42]                      | [Apache-2.0][32]                               |
| [Apache Maven Assembly Plugin][43]                      | [Apache-2.0][32]                               |
| [Apache Maven JAR Plugin][44]                           | [Apache-2.0][32]                               |
| [Artifact reference checker and unifier][45]            | [MIT License][46]                              |
| [spdx-maven-plugin Maven Plugin][47]                    | [The Apache Software License, Version 2.0][37] |
| [Project Keeper Maven plugin][48]                       | [The MIT License][49]                          |
| [Apache Maven Dependency Plugin][50]                    | [Apache-2.0][32]                               |
| [Maven Failsafe Plugin][51]                             | [Apache-2.0][32]                               |
...
| [Apache Maven Clean Plugin][57]                         | [Apache-2.0][32]                               |
| [Apache Maven Resources Plugin][58]                     | [Apache-2.0][32]                               |
| [Apache Maven Install Plugin][59]                       | [Apache-2.0][32]                               |
| [Apache Maven Site Plugin][60]                          | [Apache-2.0][32]                               |
...
[26]: https://github.com/eclipse-ee4j/jsonp
[27]: https://projects.eclipse.org/license/epl-2.0
[28]: https://projects.eclipse.org/license/secondary-gpl-2.0-cp
